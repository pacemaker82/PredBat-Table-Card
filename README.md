...
6. Goto dashboard, edit dashboard, add card button, and add the new custom Predbat Table Card. Default YAML setup below should be there to help get started.
